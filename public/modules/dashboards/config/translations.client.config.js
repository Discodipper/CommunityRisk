...
var static_es = {
  ...
  vulnerability_score_tag:
    "Haga clic para ver los componentes de vulnerabilidad",
  coping_score_tag:
    "Haga clic para conocer los componentes de la capacidad de afrontamiento",
  other_variables: "Otras variables",
  other_variables_tag:
    "No forma parte del marco de riesgo, pero sigue siendo relevante.",
  sort_by: "Ordenar por ...",
...
var static_fr = {
  ...
  coping_score_tag:
    "Cliquez pour voir les composantes de capacité d'adaptation",
  other_variables: "Autres indicateurs",
  other_variables_tag:
    "En dehors de l'équation du risque, mais toujours pertinent.",
  sort_by: "Trier par ...",
...
angular.module("dashboards").config(function($translateProvider) {
  d3.dsv(
    ...
    $translateProvider.translations(
      "en",
      $.extend({}, angular_vars, static_en, labels_en, descriptions_en)
    );
    $translateProvider.translations(
      "es",
      $.extend({}, angular_vars, static_es, labels_es, descriptions_es)
    );
    $translateProvider.translations(
      "fr",
